    ...
    operations = [
        ...
        migrations.AddConstraint(
            ...
            constraint=models.CheckConstraint(
                check=models.Q(("weight__gte", 0.0), ("weight__lte", 1.0)), name="link_weight_range"
            ),
        ),
        migrations.AddConstraint(
            model_name="link",
            constraint=models.CheckConstraint(
                check=models.Q(("direction__gte", 0), ("direction__lte", 3)), name="link_direction_range"
            ),
        ),
    ]
