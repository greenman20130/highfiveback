...
POLL_SERVICE_URL = os.environ.get('POLL_SERVICE_URL', 'http://127.0.0.1:8001/api/')
USER_SERVICE_URL = os.environ.get('USER_SERVICE_URL', 'http://127.0.0.1:8001/api/')
COMMENT_SERVICE_URL = os.environ.get('COMMENT_SERVICE_URL', 'http://127.0.0.1:8001/api/')
