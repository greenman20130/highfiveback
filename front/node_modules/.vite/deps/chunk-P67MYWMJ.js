...
function SeriesContextProvider(props) {
  ...
  const formattedSeries = React5.useMemo(() => formatSeries(series, typeof colors === "function" ? colors(theme.palette.mode) : colors, dataset), [series, colors, theme.palette.mode, dataset]);
...
function CartesianContextProvider(props) {
  ...
  const formattedSeries = React7.useContext(SeriesContext);
  const drawingArea = useDrawingArea();
  const xAxis = React7.useMemo(() => inXAxis == null ? void 0 : inXAxis.map((axisConfig) => {
  ...
  const yAxis = React7.useMemo(() => inYAxis == null ? void 0 : inYAxis.map((axisConfig) => {
    const dataKey = axisConfig.dataKey;
    if (dataKey === void 0 || axisConfig.data !== void 0) {
      return axisConfig;
    }
...
function usePieSeries() {
  ...
  return React10.useMemo(() => series.pie, [series.pie]);
}
function useLineSeries() {
  const series = useSeries();
  return React10.useMemo(() => series.line, [series.line]);
}
function useBarSeries() {
  const series = useSeries();
  return React10.useMemo(() => series.bar, [series.bar]);
}
function useScatterSeries() {
  const series = useSeries();
  return React10.useMemo(() => series.scatter, [series.scatter]);
}
...
//# sourceMappingURL=chunk-P67MYWMJ.js.map
