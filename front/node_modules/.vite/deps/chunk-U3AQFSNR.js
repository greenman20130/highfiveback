...
function ChartsYAxis(inProps) {
  ...
  return (0, import_jsx_runtime5.jsxs)(AxisRoot, {
...
function ChartsAxis(props) {
  ...
  return (0, import_jsx_runtime7.jsxs)(React5.Fragment, {
    children: [topId && (0, import_jsx_runtime6.jsx)(ChartsXAxis, _extends({}, topAxisProps, {
      position: "top",
      axisId: topId
    })), bottomId && (0, import_jsx_runtime6.jsx)(ChartsXAxis, _extends({}, bottomAxisProps, {
      position: "bottom",
      axisId: bottomId
    })), leftId && (0, import_jsx_runtime6.jsx)(ChartsYAxis, _extends({}, leftAxisProps, {
      position: "left",
      axisId: leftId
    })), rightId && (0, import_jsx_runtime6.jsx)(ChartsYAxis, _extends({}, rightAxisProps, {
      position: "right",
      axisId: rightId
    }))]
  });
...
true ? DefaultChartsItemTooltipContent.propTypes = {
   ...
   */
  getColor: import_prop_types5.default.func.isRequired,
  /**
   * The data used to identify the triggered item.
   */
  itemData: import_prop_types5.default.shape({
    ...
    type: import_prop_types5.default.oneOf(["bar", "line", "pie", "scatter"]).isRequired
  }).isRequired,
  /**
...
function getColor5(series, xAxis, yAxis) {
  if (xAxis !== void 0 && yAxis !== void 0) {
    ...
    if (series.type === "scatter") {
      return getColor3(series, xAxis, yAxis);
    }
  }
  if (series.type === "pie") {
...
function ChartsItemTooltipContent(props) {
  ...
  const series = React7.useContext(SeriesContext)[itemData.type].series[itemData.seriesId];
  ...
  const getColor6 = series.type === "pie" ? colorGetter_default(series) : colorGetter_default(series, xAxis[series.xAxisKey ?? defaultXAxisId], yAxis[series.yAxisKey ?? defaultYAxisId]);
  ...
  return (0, import_jsx_runtime10.jsx)(Content, _extends({}, chartTooltipContentProps));
}
true ? ChartsItemTooltipContent.propTypes = {
  ...
  contentProps: import_prop_types6.default.shape({
    classes: import_prop_types6.default.object,
    getColor: import_prop_types6.default.func,
    ...
    series: import_prop_types6.default.object,
...
function useMouseTracker() {
  const svgRef = React8.useContext(SvgContext);
  const [mousePosition, setMousePosition] = React8.useState(null);
  React8.useEffect(() => {
...
function DefaultChartsAxisTooltipContent(props) {
  ...
  return (0, import_jsx_runtime11.jsx)(ChartsTooltipPaper, {
    sx,
    className: classes.root,
    children: (0, import_jsx_runtime12.jsxs)(ChartsTooltipTable, {
      className: classes.table,
      children: [axisValue != null && !axis.hideTooltip && (0, import_jsx_runtime11.jsx)("thead", {
        children: (0, import_jsx_runtime11.jsx)(ChartsTooltipRow, {
      ...
      }), (0, import_jsx_runtime11.jsx)("tbody", {
        children: series.filter(isCartesianSeries).map(({
          ...
          return (0, import_jsx_runtime12.jsxs)(ChartsTooltipRow, {
            className: classes.row,
            children: [(0, import_jsx_runtime11.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.markCell, classes.cell),
              ...
              className: clsx_default(classes.labelCell, classes.cell),
              children: label ? (0, import_jsx_runtime11.jsx)(Typography_default, {
                children: label
              }) : null
            }), (0, import_jsx_runtime11.jsx)(ChartsTooltipCell, {
              className: clsx_default(classes.valueCell, classes.cell),
...
true ? DefaultChartsAxisTooltipContent.propTypes = {
   ...
   */
  axisValue: import_prop_types7.default.any.isRequired,
  /**
   * Override or extend the styles applied to the component.
   */
...
function ChartsAxisTooltipContent(props) {
  ...
  const series = React10.useContext(SeriesContext);
  const USED_AXIS_ID = isXaxis ? xAxisIds[0] : yAxisIds[0];
  const relevantSeries = React10.useMemo(() => {
    const rep = [];
    Object.keys(series).filter(isCartesianSeriesType).forEach((seriesType) => {
      series[seriesType].seriesOrder.forEach((seriesId) => {
        ...
        if (axisKey === void 0 || axisKey === USED_AXIS_ID) {
          ...
          const color = colorGetter_default(seriesToAdd, xAxis[seriesToAdd.xAxisKey ?? xAxisIds[0]], yAxis[seriesToAdd.yAxisKey ?? yAxisIds[0]]);
  ...
  const relevantAxis = React10.useMemo(() => {
...
true ? ChartsAxisTooltipContent.propTypes = {
  ...
  // | To update them edit the TypeScript types and run "yarn proptypes"  |
  // ----------------------------------------------------------------------
  axisData: import_prop_types8.default.shape({
    x: import_prop_types8.default.shape({
      index: import_prop_types8.default.number,
      value: import_prop_types8.default.oneOfType([import_prop_types8.default.instanceOf(Date), import_prop_types8.default.number, import_prop_types8.default.string]).isRequired
    }),
    y: import_prop_types8.default.shape({
      index: import_prop_types8.default.number,
      value: import_prop_types8.default.oneOfType([import_prop_types8.default.instanceOf(Date), import_prop_types8.default.number, import_prop_types8.default.string]).isRequired
    })
  }).isRequired,
  classes: import_prop_types8.default.object.isRequired,
  content: import_prop_types8.default.elementType,
  contentProps: import_prop_types8.default.shape({
    axis: import_prop_types8.default.object,
    axisData: import_prop_types8.default.shape({
      x: import_prop_types8.default.shape({
        index: import_prop_types8.default.number,
        value: import_prop_types8.default.oneOfType([import_prop_types8.default.instanceOf(Date), import_prop_types8.default.number, import_prop_types8.default.string]).isRequired
    ...
    axisValue: import_prop_types8.default.any,
    classes: import_prop_types8.default.object,
    dataIndex: import_prop_types8.default.number,
    series: import_prop_types8.default.arrayOf(import_prop_types8.default.object),
...
var InteractionContext = React11.createContext({
  item: null,
  axis: {
    x: null,
    y: null
...
function InteractionProvider(props) {
  ...
  const [data, dispatch] = React11.useReducer(dataReducer, {
    item: null,
    axis: {
      x: null,
      y: null
...
function DefaultChartsLegend(props) {
  ...
  const labelStyle = React13.useMemo(
  ...
  const padding = React13.useMemo(() => getStandardizedPadding(paddingProps), [paddingProps]);
  const getItemSpace = React13.useCallback((label, inStyle = {}) => {
  ...
  const [seriesWithPosition, legendWidth, legendHeight] = React13.useMemo(() => {
    let x = 0;
    let y = 0;
...
true ? DefaultChartsLegend.propTypes = {
  ...
  drawingArea: import_prop_types10.default.shape({
    bottom: import_prop_types10.default.number.isRequired,
    height: import_prop_types10.default.number.isRequired,
    left: import_prop_types10.default.number.isRequired,
    right: import_prop_types10.default.number.isRequired,
  ...
  seriesToDisplay: import_prop_types10.default.arrayOf(import_prop_types10.default.shape({
...
function ChartsLegend(inProps) {
  ...
  return (0, import_jsx_runtime18.jsx)(ChartLegendRender, _extends({}, chartLegendRenderProps));
}
...
function ChartsAxisHighlight(props) {
  ...
  return (0, import_jsx_runtime20.jsxs)(React15.Fragment, {
    children: [xAxisHighlight === "band" && axis.x !== null && isBandScale(xScale) && (0, import_jsx_runtime19.jsx)(ChartsAxisHighlightPath, {
    ...
    }), yAxisHighlight === "band" && axis.y !== null && isBandScale(yScale) && (0, import_jsx_runtime19.jsx)(ChartsAxisHighlightPath, {
...
var _excluded6 = ["children", "width", "height", "viewBox", "disableAxisListener", "className", "title", "desc"];
...
var ChartsSurface = React17.forwardRef(function ChartsSurface2(props, ref) {
  ...
  return (0, import_jsx_runtime22.jsxs)(ChartChartsSurfaceStyles, _extends({
    width,
    height,
    viewBox: `${svgView.x} ${svgView.y} ${svgView.width} ${svgView.height}`,
    ref
  }, other, {
    children: [(0, import_jsx_runtime21.jsx)("title", {
      children: title
    }), (0, import_jsx_runtime21.jsx)("desc", {
      children: desc
    }), children]
  }));
});
...
var withAnimated = (Component, host2) => {
  ...
  return (0, import_react9.forwardRef)((givenProps, givenRef) => {
    ...
    return React18.createElement(Component, { ...usedProps, ref });
  });
};
...
var SpringContext = ({
  ...
  const { Provider } = ctx;
  return React19.createElement(Provider, { value: props }, children);
};
var ctx = makeContext(SpringContext, {});
SpringContext.Provider = ctx.Provider;
SpringContext.Consumer = ctx.Consumer;
function makeContext(target, init) {
  Object.assign(target, React19.createContext(init));
...
var HighlighContext = React20.createContext({
  item: null,
  scope: defaultScope,
  dispatch: () => null
});
...
function HighlightProvider(props) {
  ...
  const [data, dispatch] = React20.useReducer(dataReducer2, {
    item: null,
    scope: defaultScope
  });
  const value = React20.useMemo(() => _extends({}, data, {
    dispatch
  }), [data]);
  return (0, import_jsx_runtime23.jsx)(HighlighContext.Provider, {
    value,
    children
  });
}
  ...
  return (0, import_jsx_runtime24.jsx)("linearGradient", {
    ...
    children: colorMap.thresholds.map((threshold, index) => {
      ...
      return (0, import_jsx_runtime25.jsxs)(React21.Fragment, {
        children: [(0, import_jsx_runtime24.jsx)("stop", {
          offset,
          stopColor: colorMap.colors[index],
          stopOpacity: 1
        }), (0, import_jsx_runtime24.jsx)("stop", {
          offset,
...
function ChartsContinuousGradient(props) {
  ...
  return (0, import_jsx_runtime26.jsx)("linearGradient", {
    id: gradientId,
    x1: "0",
    x2: "0",
    y1: "0",
    ...
    children: Array.from({
      ...
      return (0, import_jsx_runtime26.jsx)("stop", {
        offset,
        stopColor: color,
        stopOpacity: 1
      }, keyPrefix + index);
...
function useChartGradient() {
  ...
  return React24.useCallback((axisId, direction) => `${chartId}-graient-${direction}-${axisId}`, [chartId]);
}
function ChartsAxesGradients() {
  ...
  return (0, import_jsx_runtime28.jsxs)("defs", {
    children: [yAxisIds.filter((axisId) => yAxis[axisId].colorMap !== void 0).map((axisId) => {
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "piecewise") {
        return (0, import_jsx_runtime27.jsx)(ChartsPiecewiseGradient, {
          isReveresed: !reverse,
          scale,
          colorMap,
          size: svgHeight,
      ...
      if ((colorMap == null ? void 0 : colorMap.type) === "continuous") {
        return (0, import_jsx_runtime27.jsx)(ChartsContinuousGradient, {
          isReveresed: !reverse,
          scale,
          colorScale,
          colorMap,
...
var ChartContainer = React25.forwardRef(function ChartContainer2(props, ref) {
  ...
  useReducedMotion2();
  return (0, import_jsx_runtime29.jsx)(DrawingProvider, {
    width,
    height,
    margin,
    svgRef,
    children: (0, import_jsx_runtime29.jsx)(SeriesContextProvider, {
      series,
      colors: colors3,
      dataset,
      children: (0, import_jsx_runtime29.jsx)(CartesianContextProvider, {
        xAxis,
        yAxis,
        dataset,
        children: (0, import_jsx_runtime29.jsx)(InteractionProvider, {
          children: (0, import_jsx_runtime29.jsx)(HighlightProvider, {
            children: (0, import_jsx_runtime30.jsxs)(ChartsSurface, {
              width,
              height,
              ref: handleRef,
              sx,
              ...
              desc,
              disableAxisListener,
              children: [(0, import_jsx_runtime29.jsx)(ChartsAxesGradients, {}), children]
            })
          })
        })
      })
...
var ResponsiveChartContainer = React27.forwardRef(function ResponsiveChartContainer2(props, ref) {
  ...
  return (0, import_jsx_runtime31.jsx)(ResizableContainer, {
    ref: containerRef,
    ownerState: {
      width: inWidth,
      height: inHeight
    },
    children: width && height ? (0, import_jsx_runtime31.jsx)(ChartContainer, _extends({}, other, {
      width,
      height,
      ref
    })) : null
...
true ? ResponsiveChartContainer.propTypes = {
  ...
  xAxis: import_prop_types15.default.arrayOf(import_prop_types15.default.shape({
    ...
    max: import_prop_types15.default.oneOfType([import_prop_types15.default.instanceOf(Date), import_prop_types15.default.number]),
    min: import_prop_types15.default.oneOfType([import_prop_types15.default.instanceOf(Date), import_prop_types15.default.number]),
    position: import_prop_types15.default.oneOf(["bottom", "left", "right", "top"]),
...
var useInteractionItemProps = (scope, skip) => {
  ...
  } = React28.useContext(HighlighContext);
  if (skip) {
    return () => ({});
  }
...
//# sourceMappingURL=chunk-U3AQFSNR.js.map
