  ...
  return (
    <div className="SecondTab">
      ...
      <ReportDiv label="Динамика" width="186px" height="186px">
        <>
        <p style={{"fontSize": "9px"}}>{calcResult}</p>
        <p style={{"fontSize": "9px"}}><span style={{"font-size": "9px", "font-weight": "700"}}>{time}</span>
        {calcResultCont}</p>
        </>
      </ReportDiv>
      </div>
      ...
      <ReportDiv label="До" width="422px" height="295px"><PieChartWithLabel data={pieChartData} label={54} width={201} height={279} pos="left"/></ReportDiv>
      <ReportDiv label="После" width="422px" height="295px"><PieChartWithLabel data={pieChartData2} label={54} width={201} height={279} pos="left"/></ReportDiv>
      <ReportDiv label="Помните" width="186px" height="295px">
        <>
        <p style={{"fontSize": "9px"}}>{calcRes2}</p>
        <p style={{"fontSize": "9px"}}>{calcRes2Cont}</p>
        </>
        </ReportDiv>
